/**
 * DoH-ECH 核心服务 (已移除 force 参数)
 * 包括：ECS, best, sub, exclude, area, shuffle, enhance (rule/full), ALPN
 * 内置常用站点 IP，通配符规则匹配域名本身
 */
...
// ⚠️ 请替换为您的 CIDR 列表
const RAW_META_CIDRS = [ /* Meta CIDR */ ];
const RAW_CF_CIDRS   = [ /* Cloudflare CIDR */ ];
    ...
    <div class="container">
        ...
        <div class="global-section">
            <div class="param-grid">
                ...
                <div>
                    <label>自定义 ClientIP (ECS) <span class="badge">clientIp</span></label></label>
